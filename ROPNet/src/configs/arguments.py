...
def config_params():
    parser = argparse.ArgumentParser(description='Configuration Parameters',
                                     add_help=False)
    ## dataset
    parser.add_argument('--root', required=False, help='the data path')
    parser.add_argument('--data_type', type=str, required=False, help='type of data to be used', default='RANSACOriginal', 
                        choices=['RANSACOriginal','RANSACCropped','RigidCPDOriginal','RigidCPDCropped','NonRigidCPDOriginal','NonRigidCPDCropped','AffineCPDOriginal','AffineCPDCropped'])
    ...
    ## model
    parser.add_argument('--train_N1', type=int, default=448*2, help='')
    parser.add_argument('--train_M1', type=int, default=717*2, help='')
    parser.add_argument('--train_similarity_topk', type=int, default=3, help='')
    parser.add_argument('--test_N1', type=int, default=448*2, help='')
    parser.add_argument('--test_M1', type=int, default=717*2, help='')
...
def eval_config_params():
    ...
    parser.add_argument('--feat_dim', type=int, default=192,
                        help='Feature dimension (to compute distances on)')
    parser.add_argument('--checkpoint', default='work_dirs/models/checkpoints/min_test_rot_error_0.pth',
