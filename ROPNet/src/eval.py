...
def evaluate_ROPNet(args, test_loader):
    ...
    with torch.no_grad():
        for i, (tgt_cloud, src_cloud, gtR, gtt) in tqdm(enumerate(test_loader)):
            ...
            gt_transformed_src_rop = batch_transform(src_rop[..., :3], gtR,
                                                 gtt)
