...
from ngenet.utils import square_dists
...
class Loss(nn.Module):
    ...
    def overlap_loss(self, ol_scores, ol_gt):
        ...
        :return:
        '''
        ol_scores = torch.nan_to_num(ol_scores)
    ...
    def saliency_loss(self, saliency, saliency_gt):
        ...
        :return:
        '''
        saliency = torch.nan_to_num(saliency)
    ...
    def forward(self, coords_src, coords_tgt, feats_src, feats_tgt, feats_src_m, feats_tgt_m, feats_src_l, feats_tgt_l, coors, transf, w_saliency):
        ...
        elif transf.shape == coords_src.shape:
            coords_src = coords_src + transf
        else:
            print('Transform has wrong shape')
            1/0
